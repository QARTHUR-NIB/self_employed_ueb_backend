...
sched.add_job(send_notice_to_all_paid_applicants,'cron',id="payment_notice",hour='0',minute='0',start_date='2020-04-03')
sched.start()
...
app.config['SUN_CASH_FOLDER'] = SUN_CASH_FOLDER
