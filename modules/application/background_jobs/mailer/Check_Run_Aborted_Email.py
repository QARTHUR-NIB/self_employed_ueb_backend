...
class Check_Run_Aborted_Email(Mass_Email):
    def __init__(self,template):
        self.recipient = "quincyarthur@gmail.com"#"CJohnson@nib-bahamas.com,Ronnie.Mortimer@nib-bahamas.com,ASands@nib-bahamas.com,LKnowles@nib-bahamas.com,QArthur@nib-bahamas.com,DBethel@nib-bahamas.com"
